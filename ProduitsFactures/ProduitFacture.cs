...
namespace Facturio.ProduitsFactures
{
    public class ProduitFacture
    {
        ...
        public virtual decimal SousTotalSommaire { get { return (decimal)(NbFoisVendu * Produit.Prix); } set { SousTotalSommaire = value; } }
        public virtual float NbFoisVendu { get; set; } = 0;
